...
public class VmController {
    ...
    public ResultUtil<VmSnapshotModel> createSnapshot(@RequestParam("name") String name, @RequestParam("description") String description) {
        return ResultUtil.success(vmService.createSnapshot(name, description));
    }
