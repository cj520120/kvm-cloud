...
cp -r ./gitee-kvm-cloud/cloud-kvm-agent/* ~/Code/nfs/code/gitee-kvm-cloud/cloud-kvm-agent/
cp -r ./gitee-kvm-cloud/cloud-common/* ~/Code/nfs/code/gitee-kvm-cloud/cloud-common/
cp -r ./gitee-kvm-cloud/cloud-management/* ~/Code/nfs/code/gitee-kvm-cloud/cloud-management/
