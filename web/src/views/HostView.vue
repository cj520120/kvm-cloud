		...
		<el-container>
			<el-main>
				<el-card class="box-card" v-show="this.show_type === 0">
					...
					<el-row>
						<el-table :v-loading="data_loading" :data="hosts" style="width: 100%" border>
							<el-table-column label="ID" prop="hostId" width="80" />
							<el-table-column label="名称" prop="displayName" min-width="100" show-overflow-tooltip />
							<el-table-column label="主机IP" prop="hostIp" width="120" />
							<el-table-column label="CPU" prop="hostIp" min-width="120">
							...
							<el-table-column label="内存" prop="hostIp" min-width="120">
								<template #default="scope">
