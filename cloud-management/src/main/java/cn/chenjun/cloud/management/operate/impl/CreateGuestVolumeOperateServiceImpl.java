...
@Component
@Slf4j
public class CreateGuestVolumeOperateServiceImpl extends CreateVolumeOperateServiceImpl<CreateGuestVolumeOperate> {
    ...
    public void onFinish(CreateGuestVolumeOperate param, ResultUtil<VolumeInfo> resultUtil) {
        ...
        if (resultUtil.getCode() == ErrorCode.SUCCESS) {
            ...
            VolumeEntity volume = this.volumeDao.findById(param.getVolumeId());
