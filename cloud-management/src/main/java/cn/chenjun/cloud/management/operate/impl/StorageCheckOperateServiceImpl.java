...
@Component
@Slf4j
public class StorageCheckOperateServiceImpl extends AbstractOperateService<StorageCheckOperate, ResultUtil<List<StorageInfo>>> {
    ...
    public void onFinish(StorageCheckOperate param, ResultUtil<List<StorageInfo>> resultUtil) {
        ...
        if (resultUtil.getCode() == ErrorCode.SUCCESS) {
            ...
            for (StorageInfo info : storageInfoList) {
                ...
                StorageEntity sourceEntity = this.storageDao.findByName(info.getName());
