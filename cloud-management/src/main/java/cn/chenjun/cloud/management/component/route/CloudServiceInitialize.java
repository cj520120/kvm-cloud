...
public class CloudServiceInitialize implements RouteComponentQmaInitialize {
    ...
    public List<GuestQmaRequest.QmaBody> initialize(ComponentEntity component, int guestId, Map<String, Object> sysconfig) {
        ...
        String cloudService = new String(Base64.getDecoder().decode(ResourceUtil.readUtf8Str("tpl/component/cloud/cloud_service.tpl").getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        String cloudPython = new String(Base64.getDecoder().decode(ResourceUtil.readUtf8Str("tpl/component/cloud/cloud_py.tpl").getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        ...
        cloudPython = JinjavaParser.create().render(cloudPython, map);
