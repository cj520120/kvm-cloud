...
@Slf4j
@Component
public class ComponentMetaAction implements WsAction<MapData> {
    @Autowired
    ...
    public void doAction(Client webSocket, WsMessage<MapData> msg) throws IOException {
        ...
        if (webSocket.getContext() != null) {
            ...
            webSocket.sendJsonPacket(WsMessage.builder().command(Constant.SocketCommand.COMPONENT_META_RESPONSE).data(map).build());
