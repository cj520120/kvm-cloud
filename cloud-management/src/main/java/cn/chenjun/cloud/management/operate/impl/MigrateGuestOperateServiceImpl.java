...
@Component
@Slf4j
public class MigrateGuestOperateServiceImpl extends AbstractOperateService<MigrateGuestOperate, ResultUtil<Void>> {
    ...
    public void operate(MigrateGuestOperate param) {
        ...
        if (guest.getStatus() == Constant.GuestStatus.MIGRATE) {
            ...
            HostEntity host = this.hostDao.findById(param.getToHostId());
            ...
            HostEntity sourceHost = this.hostDao.findById(param.getSourceHostId());
