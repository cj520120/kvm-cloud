...
@EnablePluginRegistries({ClusterMessageProcess.class, Operate.class, ComponentProcess.class, MetaDataService.class, UserDataService.class, VendorDataService.class})
